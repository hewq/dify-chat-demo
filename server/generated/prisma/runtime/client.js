...
var $u = (e) => e,
  ...
  h = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, '__id', { value: ++Lu }),
          e.__id
        )
      },
...
function He(e = {}) {
  ...
  return Object.entries(t).reduce(
    (n, [i, o]) => (
      _o[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o),
      n
    ),
    { select: {} }
  )
  ...
  async interpretNode(t, r) {
    switch (t.type) {
      ...
      case 'execute': {
        ...
        for (let o of n) {
          ...
          i += await this.#u(s, r.queryable, () =>
            r.queryable
              .executeRaw(ri(s))
              .catch((a) => (t.args.type === 'rawSql' ? Sn(a) : Ge(a)))
          )
        }
        return { value: i }
      }
        ...
        for (let o of n) {
          let s = Ia(o, r.sqlCommenter),
            a = await this.#u(s, r.queryable, () =>
              r.queryable
                .queryRaw(ri(s))
                .catch((l) => (t.args.type === 'rawSql' ? Sn(l) : Ge(l)))
            )
          i === void 0
            ? (i = a)
      ...
      case 'process': {
        ...
        return (
          Na(o, r.scope, r.generators),
          { value: kr(n, o), lastInsertId: i }
        )
      }
    ...
    ;((this.#r = r ?? ll),
      ...
      (this.#i =
        t.queryPlanCacheMaxSize === 0
          ? void 0
          : new Vr(t.queryPlanCacheMaxSize)),
...
`,
    ...
    _request(n) {
      ...
      return this._tracingHelper.runInChildSpan(s.operation, () =>
        new zl.AsyncResource('prisma-client-request').runInAsyncScope(() =>
          a(o)
        )
      )
    }
